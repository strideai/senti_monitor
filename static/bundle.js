...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Article = __webpack_require__(231);
	...
	var _CompareView = __webpack_require__(242);
	...
	var App = function (_React$Component) {
		...
		function App(props) {
			...
			_this.state = {
				articles: [],
				entities: [],
				topEntities: ['The Bank of England', 'PayPal', 'eBay', 'The Federal Reserve Bank', 'Comcast', 'Pandora One', 'Walmart', 'Google', 'Toyota', 'Jos . A. Bank Clothiers'],

				dataLoaded: false
			};
			_this.loadFeed = _this.loadFeed.bind(_this);
			fetch(Constant.API_ROOT_URL + '/feed?offset=0&limit=100').then(function (response) {
		...
		_createClass(App, [{
			key: 'loadFeed',
			value: function loadFeed(json) {
				this.setState({ feedLoaded: true });
				this.setState({ articles: json });
				var entities = [];
				this.state.articles.forEach(function (a) {
					return a.entities.forEach(function (e) {
						return entities.push(e.text);
					});
				});
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouter.IndexRoute, { component: function component() {
								return _react2.default.createElement(_Home2.default, { topEntities: _this2.state.topEntities, entities: _this2.state.entities, articles: _this2.state.articles });
							} }),
						_react2.default.createElement(_reactRouter.Route, { path: '/compare', component: function component() {
								return _react2.default.createElement(_CompareView2.default, { topEntities: _this2.state.topEntities, entities: _this2.state.entities });
							} }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Feed = __webpack_require__(224);

	var _Feed2 = _interopRequireDefault(_Feed);

	var _Entities = __webpack_require__(227);
	...
	var _immutabilityHelper = __webpack_require__(232);
	...
	var _FilterBar = __webpack_require__(234);

	var _FilterBar2 = _interopRequireDefault(_FilterBar);

	var _reactFetch = __webpack_require__(235);
	...
	var Home = function (_React$Component) {
		...
		function Home(props) {
			...
			_this.handleChangeSelectedEntities = _this.handleChangeSelectedEntities.bind(_this);
			_this.handleChoice = _this.handleChoice.bind(_this);
			_this.selectedIndexOf = _this.selectedIndexOf.bind(_this);
			return _this;
		}
		...
		_createClass(Home, [{
			...
			key: 'handleChangeSelectedEntities',
			value: function handleChangeSelectedEntities(entity) {
				var index = this.selectedIndexOf(entity);
				if (index != -1) {
					this.setState({ selectedEntities: (0, _immutabilityHelper2.default)(this.state.selectedEntities, { $splice: [[index, 1]] }) });
				} else {
					this.setState({ selectedEntities: (0, _immutabilityHelper2.default)(this.state.selectedEntities, { $push: [entity] }) });
				}
			}
			...
			key: 'handleChoice',
			value: function handleChoice(sortBy) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_FilterBar2.default, { handleChoice: handleChoice }),
					_react2.default.createElement(
						'div',
						{ className: 'container-fluid', style: { 'marginTop': '14px' } },
						_react2.default.createElement(
							'div',
							{ className: 'row' },
							...
							_react2.default.createElement(
								'div',
								{ className: 'col-sm-3 entity-list-col' },
								_react2.default.createElement(_Entities2.default, { topEntities: this.props.topEntities, entities: this.props.entities, selectedIndexOf: this.selectedIndexOf, handleChangeSelectedEntities: this.handleChangeSelectedEntities, selectedEntities: this.state.selectedEntities })
							),
							_react2.default.createElement(
								'div',
								{ className: 'col-sm-8' },
								_react2.default.createElement(_Feed2.default, { articles: this.props.articles, feedLoaded: this.state.feedLoaded, handleChangeSelectedEntities: this.handleChangeSelectedEntities, selectedIndexOf: this.selectedIndexOf, sortBy: this.state.sortBy, selectedEntities: this.state.selectedEntities })
							)
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleListItem = __webpack_require__(225);
	...
	var Feed = function (_React$Component) {
		...
		_createClass(Feed, [{
			...
			value: function render() {
				...
				var isArticleSelected = function isArticleSelected(a) {
					for (var i = 0; i < selected.length; i++) {
						for (var j = 0; j < a.entities.length; j++) {
							if (a.entities[j].text == selected[i]) return true;
						}
					}
					return false;
				};
				...
				var result = articles.filter(function (a) {
					return selected.length == 0 || isArticleSelected(a);
				});
				...
				var sorted = result.sort(function (a, b) {
					...
					return _react2.default.createElement(_ArticleListItem2.default, { onClick: _this2.props.handleChangeSelectedEntities, key: a.id, article: a });
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArticleListItem = function (_React$Component) {
		_inherits(ArticleListItem, _React$Component);

		function ArticleListItem(props) {
			_classCallCheck(this, ArticleListItem);

			var _this = _possibleConstructorReturn(this, (ArticleListItem.__proto__ || Object.getPrototypeOf(ArticleListItem)).call(this, props));
		...
		_createClass(ArticleListItem, [{
			...
			key: 'prettyDate',
			value: function prettyDate(time) {
				var date = new Date((time || "").replace(/-/g, "/").replace(/[TZ]/g, " ")),
				    diff = (new Date().getTime() - date.getTime()) / 1000,
				    day_diff = Math.floor(diff / 86400);

				if (isNaN(day_diff) || day_diff < 0 || day_diff >= 31) return this.formatDate(date);

				return day_diff == 0 && (diff < 60 && "just now" || diff < 120 && "1 minute ago" || diff < 3600 && Math.floor(diff / 60) + " minutes ago" || diff < 7200 && "1 hour ago" || diff < 86400 && Math.floor(diff / 3600) + " hours ago") || day_diff == 1 && "Yesterday" || day_diff < 7 && day_diff + " days ago" || day_diff < 31 && Math.ceil(day_diff / 7) + " weeks ago";
			}
		}, {
			key: 'handleTagClick',
			value: function handleTagClick(entity) {
				this.props.onClick(entity);
			}
		}, {
			key: 'getSentimentTag',
			value: function getSentimentTag(entity) {
				var _this2 = this;

				entity.score = entity.positive_score + entity.negative_score;
				return entity.score >= 0 ? _react2.default.createElement(
					'span',
					{ key: entity.text, onClick: function onClick() {
							return _this2.handleTagClick(entity.text);
			...
			value: function render() {
				...
				var tags = [];
				this.props.article.entities.forEach(function (e) {
					return tags.push(_this3.getSentimentTag(e));
				});
				return _react2.default.createElement(
					'div',
					{ className: 'card article-list-item' },
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							this.props.article.id ? this.prettyDate(new Date(this.props.article.id).toDateString()) : '',
							' \u2022 ',
							Constant.sentiments[this.props.article.articleSentiment.sentiment]
						),
						_react2.default.createElement(
							'h4',
							null,
							_react2.default.createElement(
								_reactRouter.Link,
								{ className: 'article-title', to: "/article/" + this.props.article.id },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EntityList = __webpack_require__(229);
	...
	var Entities = function (_React$Component) {
		_inherits(Entities, _React$Component);

		function Entities(props) {
			_classCallCheck(this, Entities);

			var _this = _possibleConstructorReturn(this, (Entities.__proto__ || Object.getPrototypeOf(Entities)).call(this, props));
		...
		_createClass(Entities, [{
			key: 'handleUserInput',
			value: function handleUserInput(filter) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EntityListItem = __webpack_require__(230);
	...
	var EntityList = function (_React$Component) {
		...
		function EntityList(props) {
			...
			return _possibleConstructorReturn(this, (EntityList.__proto__ || Object.getPrototypeOf(EntityList)).call(this, props));
		}
			...
			value: function render() {
				...
				var getEntityList = function getEntityList(entities) {
					return entities.sort().map(function (e) {
						return _react2.default.createElement(_EntityListItem2.default, { key: e, entity: e, selected: _this2.props.selectedIndexOf(e) != -1, onClick: handleClick });
					});
				};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EntityListItem = function (_React$Component) {
		_inherits(EntityListItem, _React$Component);

		function EntityListItem(props) {
			_classCallCheck(this, EntityListItem);

			var _this = _possibleConstructorReturn(this, (EntityListItem.__proto__ || Object.getPrototypeOf(EntityListItem)).call(this, props));
		...
		_createClass(EntityListItem, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ ref: function ref(li) {
							return _this2.entityListItem = li;
						}, onClick: this.handleClick, className: this.getClassName() },
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'article',
							{ className: 'article col-sm-8' },
							_react2.default.createElement(
								'h2',
								{ className: 'article-title article-title-center' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = function (_React$Component) {
		...
		_createClass(Nav, [{
			key: 'getNavClass',
			value: function getNavClass(page) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'nav',
						{ className: 'navbar navbar-toggleable-md navbar-light bg-faded navbar-fixed-top collapse navbar-collapse' },
						_react2.default.createElement(
							_reactRouter.Link,
						...
						_react2.default.createElement(
							_reactRouter.Link,
							{ to: '/', className: this.getNavClass(Constant.pages.HOME), href: '#' },
							'Home'
						),
						_react2.default.createElement(
							_reactRouter.Link,
							{ to: '/compare', className: this.getNavClass(Constant.pages.COMPARE), href: '#' },
							'Compare'
						),
						_react2.default.createElement(
							_reactRouter.Link,
							{ to: '/rules', className: this.getNavClass(Constant.pages.RULES), href: '#' },
							'Rules'
						)
					),
					this.props.children
	...
	var FilterBar = function (_React$Component) {
		...
		_createClass(FilterBar, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'container-fluid filter-bar' },
					_react2.default.createElement(
						'div',
						{ className: 'col-sm-12' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'select',
									{ ref: function ref(input) {
											return _this2.sortSelect = input;
										}, onChange: this.onChange, className: 'filter-option' },
									_react2.default.createElement(
										'option',
										{ value: Constant.sortOptions.DATE },
										'Date'
									),
									_react2.default.createElement(
										'option',
										{ value: Constant.sortOptions.SENTIMENT },
										'Sentiment'
									)
								)
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isomorphicFetch = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RuleList = __webpack_require__(239);

	var _RuleList2 = _interopRequireDefault(_RuleList);

	var _RuleView = __webpack_require__(241);

	var _RuleView2 = _interopRequireDefault(_RuleView);
	...
	var Rules = function (_React$Component) {
		...
		function Rules(props) {
			...
			_this.handleRuleItemClick = _this.handleRuleItemClick.bind(_this);
			return _this;
		}

		_createClass(Rules, [{
			key: 'handleRuleItemClick',
			value: function handleRuleItemClick(rule) {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'rule-list-col col-sm-3' },
								_react2.default.createElement(_RuleList2.default, { rules: rules })
							),
							_react2.default.createElement(
								'div',
								{ className: 'col-sm-8' },
								_react2.default.createElement(_RuleView2.default, { rule: this.state.currentRule })
							)
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RuleListItem = __webpack_require__(240);

	var _RuleListItem2 = _interopRequireDefault(_RuleListItem);
	...
	var RuleList = function (_React$Component) {
		...
		function RuleList(props) {
			...
			return _possibleConstructorReturn(this, (RuleList.__proto__ || Object.getPrototypeOf(RuleList)).call(this, props));
		}
		...
		_createClass(RuleList, [{
			...
			value: function render() {
				...
				var getRuleList = function getRuleList(rules) {
					return rules.map(function (r) {
						return _react2.default.createElement(_RuleListItem2.default, { key: r.created, rule: r, onClick: _this2.props.onClick });
					});
				};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-primary add-new-rule' },
						'New rule'
					),
					_react2.default.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RuleListItem = function (_React$Component) {
		_inherits(RuleListItem, _React$Component);

		function RuleListItem(props) {
			_classCallCheck(this, RuleListItem);

			var _this = _possibleConstructorReturn(this, (RuleListItem.__proto__ || Object.getPrototypeOf(RuleListItem)).call(this, props));

			_this.handleClick = _this.handleClick.bind(_this);
			return _this;
		}

		_createClass(RuleListItem, [{
			key: 'handleClick',
			value: function handleClick() {
			...
			value: function render() {
				...
				var getConditions = rule.conditions.map(function (c) {
					return c + ', ';
				});
				return _react2.default.createElement(
					'div',
					{ ref: function ref(li) {
							return _this2.ruleListItem = li;
						}, onClick: this.handleClick, className: 'rule-list-item' },
					_react2.default.createElement(
						'div',
						{ className: 'rule-list-item-title' },
						rule.title
					),
					_react2.default.createElement(
						'div',
						{ className: 'rule-list-item-condition' },
						rule.conditions
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RuleView = function (_React$Component) {
		_inherits(RuleView, _React$Component);

		function RuleView(props) {
			_classCallCheck(this, RuleView);

			return _possibleConstructorReturn(this, (RuleView.__proto__ || Object.getPrototypeOf(RuleView)).call(this, props));
		}

		_createClass(RuleView, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'rule-view' },
					_react2.default.createElement('input', { type: 'text', className: 'rule-field rule-name', placeholder: 'Title', rows: '1' }),
					_react2.default.createElement('input', { type: 'text', className: 'rule-field rule-entity', placeholder: 'Entity' })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CompareColumn = __webpack_require__(243);

	var _CompareColumn2 = _interopRequireDefault(_CompareColumn);
	...
	var comparisonAttrs = [{ attr: 'mentionsCount', name: 'Total mentions' }, { attr: 'positiveRefs', name: 'Positive mentions' }, { attr: 'negativeRefs', name: 'Negative mentions' }, { attr: 'overallAvgScore', name: 'Average sentiment score' }, { attr: 'recentAvgScore', name: 'Recent sentiment score' }];

	var CompareView = function (_React$Component) {
		_inherits(CompareView, _React$Component);

		function CompareView(props) {
			_classCallCheck(this, CompareView);

			var _this = _possibleConstructorReturn(this, (CompareView.__proto__ || Object.getPrototypeOf(CompareView)).call(this, props));
			...
			_this.getColWidth = _this.getColWidth.bind(_this);
			_this.selectedIndexOf = _this.selectedIndexOf.bind(_this);
			return _this;
		}
		...
		_createClass(CompareView, [{
			...
			value: function handleChangeSelectedEntities(entity) {
				...
				console.log(params);
				var updateState = function updateState(json) {
					return _this2.setState({ comparison: json });
				};
				fetch(Constant.API_ROOT_URL + '/compare?entities=' + params).then(function (response) {
					return response.json();
				}).then(function (json) {
					updateState(json);
					console.log('aaa');
			...
			value: function getRows() {
				...
				var result = [];
				comparisonAttrs.forEach(function (attr) {
			...
			value: function getTable() {
				...
				var getHeading = comparisonAttrs.map(function (attr) {
					return _react2.default.createElement(
						'th',
						null,
						' ',
				...
				var getEntities = this.state.selectedEntities.slice(0, 3).map(function (entity) {
					return _react2.default.createElement(
						'th',
				...
				return _react2.default.createElement(
					'table',
					{ className: 'table table-bordered table-striped', style: { display: this.state.selectedEntities ? 'table' : 'none' } },
					_react2.default.createElement(
						'thead',
						null,
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CompareColumn = function (_React$Component) {
		_inherits(CompareColumn, _React$Component);

		function CompareColumn(props) {
			_classCallCheck(this, CompareColumn);

			return _possibleConstructorReturn(this, (CompareColumn.__proto__ || Object.getPrototypeOf(CompareColumn)).call(this, props));
		}

		_createClass(CompareColumn, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
